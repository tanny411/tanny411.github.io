...
3. [Preparations for Outreachy](#preparations-for-outreachy)
4. [Initial application](#initial-application)
5. [Contribution phase](#contribution-phase)
6. [Submit final application](#submit-final-application)
7. [The Internship](#the-internship)
8. [Pro-tips](#pro-tips)

## What is Outreachy?

[Outreachy](http://outreachy.org/) is a paid remote internship for 3 months with free and open-source software (FOSS), encouraging underrepresented communities in tech (but is open for all to apply), available twice a year. Outreachy has certain eligibility criteria, so make sure to go through the website for all details. In short, it is open for both students and non-students, and the amount is not small, so students may want to take note!
...
- Go to the Outreachy website, get into the mailing list, and follow the outreachy announcements. You will be notified when applications open. It's all on the website too. Read the [applicants guide](https://www.outreachy.org/docs/applicant/) and [this](https://www.outreachy.org/apply/). Go through the website.
...
- It may be a good idea to make yourself a blog. Blogging is a good idea anyway. Write for [the you of 6 months ago](https://www.fast.ai/2019/05/13/blogging-advice/). Whatever hurdles you had to overcome, you can make it easier for someone else by putting it up there. See [this](https://medium.com/@racheltho/why-you-yes-you-should-blog-7d2544ac1045) for some more motivation.
